    ...
    days: [
      {
        ...
        tables: [
          {
            headers: ["维度", "关键事实"],
            rows: [
              ["需求端", "云厂商（微软/谷歌/亚马逊/Meta）CAPEX 2024年合计超2000亿美元，80%用于购买GPU"],
              ["供给端", "英伟达数据中心市占率90%+，AMD约8%，Intel/自研芯片不足2%"],
          ...
          },
          {
            ...
            rows: [
              ...
              ["封装层(CoWoS)", "台积电2.5D/3D封装技术", "台积电90%+", "极高", "AI芯片的\'咽喉\'，扩产需18个月"],
              ["HBM存储层", "TSV 3D堆叠技术", "SK海力士50%+", "极高", "DRAM产能转向HBM，挤压标准内存"],
        ...
        investmentRotation: [
          "英伟达财报超预期 → 直接受益：台积电（CoWoS满产）、SK海力士（HBM涨价）；间接受益：光模块（中际旭创）、服务器代工（工业富联）、液冷（Vertiv）；受损/滞后：AMD（替代逻辑延后）",
      ...
      },
      {
        ...
        tables: [
          {
            ...
            rows: [
              ...
              ["为什么瓶颈", "台积电月产能3-4万片（2024），英伟达包走80%，AMD/博通抢剩余"],
              ["扩产难度", "设备交付18个月，洁净室空间受限，技术人员培养2年+"],
        ...
        keyInsights: [
          ...
          "台积电2024年CoWoS收入约80-100亿美元，2025年计划翻倍但设备未到。",
          "CoWoS封装毛利率50%+，远高于传统封装的20-30%。",
        ...
        tables: [
          {
            ...
            rows: [
              ...
              ["三巨头", "SK海力士（技术领先，HBM3E率先量产）、三星（追赶中）、美光（第三）"],
              ["价格", "HBM3E价格是标准DDR5的5-7倍，毛利率60%+"],
              ["产能分配", "2024年DRAM总产能的30%转HBM，2025年预计40%，挤压标准DRAM供应"],
            ],
          },
          {
            headers: ["厂商", "技术地位", "HBM3E进度", "市场份额", "关键客户"],
            rows: [
              ["SK海力士", "技术领先", "率先量产", "~50%", "英伟达（主供）"],
              ["三星", "追赶中", "验证中", "~40%", "AMD/自研"],
              ["美光", "第三", "追赶", "~10%", "小众客户"],
            ],
          },
        ],
        ...
        tables: [
          {
            ...
            rows: [
              ...
              ["光模块", "800G需求爆发（2024），1.6T（2025），3.2T（2026-2027）"],
            ],
          },
        ],
        keyInsights: [
          ...
          "中国厂商（中际旭创/新易盛/光迅）全球份额60%+，但核心光芯片/DSP依赖进口",
        ...
        tables: [
          {
            headers: ["维度", "关键事实"],
            rows: [
              ["台积电定价权", "3nm晶圆单价2万美元+，毛利率55%，良率领先三星20-30%"],
              ["ASML垄断", "EUV光刻机全球唯一供应商，单价2-3亿美元，订单排到2027年"],
        ...
        tables: [
          {
            ...
            rows: [
              ...
              ["电力瓶颈", "美国数据中心耗电占全国4%，2030年或达8%，电网接入排队3-5年"],
      ...
      },
      {
        ...
        tables: [
          {
            headers: ["环节", "价格由什么决定", "供需状态", "当前周期", "领先指标"],
            rows: [
              ["GPU", "英伟达定价权（稀缺性）", "紧缺", "高位震荡", "台积电CoWoS产能利用率"],
              ["HBM", "产能分配（DRAM转产比例）", "紧缺", "供不应求", "SK海力士产能指引"],
              ["CoWoS", "台积电产能利用率", "紧缺", "价格上升", "设备交付周期"],
              ["光模块", "技术迭代（800G→1.6T）", "平衡", "800G放量", "云厂商网络CAPEX"],
              ["晶圆代工", "产能利用率+制程溢价", "分化", "3nm满载", "台积电法说会指引"],
            ],
          },
          {
          ...
          },
          {
            ...
            rows: [
              ...
              ["3-4万片/月", "台积电CoWoS产能（2024）", "全球GPU出货量上限"],
        ...
        keyInsights: [
          "完整产业链地图：需求端（云厂商CAPEX 2000亿+）→ GPU（英伟达90%）→ CoWoS封装（台积电3-4万片/月）→ HBM（SK海力士50%）→ 光模块/网络（中际旭创60%）→ 数据中心/能源（Vertiv/核电）",
  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        tables: [
          {
            headers: ["环节", "供需状态", "价格趋势", "利润集中度", "领先指标", "滞后指标", "当前风险"],
            rows: [
              ["GPU", "紧缺", "↑↑", "英伟达90%", "台积电CoWoS产能", "云厂商库存", "地缘政治"],
              ["HBM", "紧缺", "↑↑", "海力士50%", "DRAM转产比例", "存储合约价", "三星追赶"],
              ["CoWoS", "紧缺", "↑", "台积电90%", "设备交付周期", "封装收入", "日月光竞争"],
              ["光模块", "平衡", "→", "中际旭创30%", "云厂商网络CAPEX", "1.6T出货量", "CPO替代"],
              ["晶圆代工", "分化", "3nm↑28nm→", "台积电60%", "产能利用率", "设备订单", "地缘政治"],
              ["基础模型", "烧钱", "↓（API降价）", "OpenAI50%", "模型能力差距", "API收入", "开源替代"],
              ["企业应用", "培育期", "探索", "分散", "企业采纳率", "付费转化率", "经济周期"],
              ["人形机器人", "概念期", "N/A", "无", "样机展示", "量产成本", "技术瓶颈"],
            ],
          },
        ],
        keyInsights: [
...
export const finReportData: FinReportSection = {
  ...
  tables: [
    ...
    },
    {
      ...
      rows: [
        ["上升期(当前?)", "英伟达收入增速>50%；云厂商CAPEX +30%+", "毛利率扩张，英伟达>70%", "库存周转下降；CAPEX/收入<35%；FCF为正", "超配GPU/HBM/CoWoS；标配光模块"],
...
export const quickRefData: QuickRefItem[] = [
  { number: "90%", meaning: "英伟达数据中心GPU市占率", significance: "垄断定价权，但反垄断风险" },
  { number: "$2-3亿", meaning: "ASML EUV光刻机单价", significance: "设备商垄断，台积电成本刚性" },
  { number: "3-4万片/月", meaning: "台积电CoWoS产能（2024）", significance: "全球GPU出货量上限" },
  { number: "5-7倍", meaning: "HBM vs DDR5价格倍数", significance: "存储厂利润弹性" },
